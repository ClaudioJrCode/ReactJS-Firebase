...
import answeredImg from '../assets/answer.svg'
...
export function AdminRoom() {
    ...
    async function handleDeleteQuestion(questionId: string) {
        if (window.confirm("Tem certeza quem voce deseja excluir a pergunta?")) {
                        ...
                        return (
                            ...
                            >
                                {!question.isAnswered && (<>
                                    ...
                                    ><img src={answeredImg} alt="Dar destaque para a pergunta" /></button>
                                </>)}
